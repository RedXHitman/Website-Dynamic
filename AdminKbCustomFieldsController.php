...
class AdminKbCustomFieldsController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        //added by aayushi to solve the problem of caching
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'hint' => $this->module->l('Enable if to make field editable in Information page', 'AdminKbCustomFieldsController'),
                        'default_values' => 1,
                    ),
                    array(
                        'type' => 'switch',
    ...
    */
    ...
    public function processAdd()
    {
        if (Tools::isSubmit('submitAddkb_custom_fields')) {
            ...
            //added by aayushi to solve the issue of having field values in radio buttons
