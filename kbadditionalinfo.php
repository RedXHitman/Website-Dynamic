...
//        $this->context->controller->addJS($this->getKbModuleDir() . 'views/js/jquery.ui.datepicker.min.js');
    }
...
//            $this->setKbMedia();
            ...
            $this->setTemplate('module:kbcustomfield/views/templates/front/display_addition_info.tpl');
